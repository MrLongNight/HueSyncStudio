...
/**
 * @class HueBridge
 * @brief Manages communication with a Philips Hue Bridge.
 *
 * Handles REST API authentication, entertainment group discovery,
 * and DTLS streaming for Entertainment API v2.
 */
...
private:
    ...
    QMap<QString, QString> m_entertainmentGroups;
};
